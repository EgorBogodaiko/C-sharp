...
System.Console.WriteLine($"Суммы строк ниже:");
PrintArrayTwo(sumsrow);
SortSumsArr(sumsrow);
System.Console.WriteLine($"Отсортировали массив с суммами строк:");
PrintArrayTwo(sumsrow);
System.Console.WriteLine($"Ответ по задаче: {ConclusionMinSumRow(sumsrow)}");
